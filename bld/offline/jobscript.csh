...
##PBS -j oe
##PBS -q batch
##PBS -l walltime=2:00:00,mppe=32,mem=8gb
##PBS -m ae
##PBS -V
##-------------------------------------------------------------------------------
...
setenv ROOTDIR /home/$LOGNAME/clm

##-------------------------------------------------------------------------------
# 4. Set directory to build the executable in
##-------------------------------------------------------------------------------

setenv MODEL_EXEDIR /ptmp/$LOGNAME/clm3run
...
## --- Cray X1 ---
  ...
  # LIB_MPI and INC_MPI do not need to be set
  setenv INC_NETCDF /apps/netcdf/prod/x1_r8/include
  setenv LIB_NETCDF /apps/netcdf/prod/x1_r8/lib
...
cat >! lnd.stdin << EOF
 ...
 finidat        = ' '
 fsurdat        = '$CSMDATA/srfdata/cam/clms_64x128_USGS_c030605.nc'
